...
\begin{figure} 
	[h]
	\centering
    \subfigure[Markierung durch Maskierung \cite{artikle2018test2}]{\includegraphics[width=0.39\textwidth]{Sources/sample.jpg}}
    \label{img:Mask} 
    \subfigure[Markierung durch Kästen \cite{google2018test1}]{\includegraphics[width=0.39\textwidth]{Sources/boxes.jpg}}
    \label{img:Boxes} 

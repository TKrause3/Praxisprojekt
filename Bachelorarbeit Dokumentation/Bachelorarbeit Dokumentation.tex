...
Als Aktivierungsfunktion werden häufig lineare und nicht linearen Funktionen Verwendet. Zusätzlich wird dem Ergebnis der Funktion der \textit{Bias} addiert.\\
\begin{eqnarray} g(( \sum_{i=0}^n x_{i} *w_{i}) +b \end{eqnarray}\\
Der \textit{Bias} ist eine Art zusätzliches Neuron, für das Verringern von Konvergenz-Problemen, welche bei der Approximation der Funktion auftreten können. Der Bias hat immer einen Eingabewert von 1 und ein Gewicht, welches unabhängig der Eingabewerte ist.\\

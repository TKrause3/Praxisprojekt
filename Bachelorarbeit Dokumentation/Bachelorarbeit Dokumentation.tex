...
\begin{tabular}{|l|c|c|c|c|}
\hline
Objektklasse & AP(Norm) & AP(GW) & AP(HA) & AP(HS)\\
\hline
Wasser - Flasche & 0.948 & \textbf{0.955} & 0.952 & 0.955\\
Orangensaft - Packung & \textbf{0.999} & 0.998 & 0.997 & 0.677\\
Milch - Packung & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & 0.871\\
Margariene & \textbf{1.000} & \textbf{1.000} & 0.997 & 1.000\\
Brunch - Aufstrich & \textbf{1.000} & 0.995 & \textbf{1.000} & 0.998\\
Flasche - Bier & 0.997 & 0.970 & \textbf{0.999} & 0.996\\
\hline
mAP & \textbf{0.991} & 0.987 & \textbf{0.991} & 0.916\\
\hline
\end{tabular}
...
\hline
sofa & 0.611 & 0.612 & \textbf{0.645} & 0.000\\ 
aeroplane & 0.845 & \textbf{0.855} & 0.823 & 0.000\\
horse & \textbf{0.924} & 0.910 & 0.902 & 0.000\\
train & 0.790 & \textbf{0.804} & 0.791 & 0.000\\
bird & \textbf{0.750} & 0.733 & 0.695 & 0.000\\ 
tvmonitor & 0.729 & \textbf{0.733} & 0.711 & 0.000\\
boat & \textbf{0.680} & 0.644 & 0.584 & 0.000\\
pottedplant & \textbf{0.430} & 0.415 & 0.411 & 0.000\\
bus & 0.797 & \textbf{0.810} & 0.733 & 0.000\\ 
diningtable & 0.532 & \textbf{0.545} & 0.485 & 0.000\\
car & 0.812 & \textbf{0.815} & 0.780 & 0.000\\
bottle & \textbf{0.553} & 0.510 & 0.476 & 0.000\\
cat & \textbf{0.903} & 0.902 & 0.860 & 0.000\\
person & \textbf{0.791} & 0.779 & 0.758 & 0.000\\
chair & 0.499 & \textbf{0.515} & 0.487 & 0.000\\
bicycle & \textbf{0.744} & 0.730 & 0.728 & 0.000\\
cow & \textbf{0.718} & 0.698 & 0.713 & 0.000\\
motorbike & \textbf{0.739} & 0.722 & 0.724 & 0.000\\
dog & \textbf{0.867} & 0.862 & 0.797 & 0.000\\
sheep & \textbf{0.645} & 0.619 & 0.580 & 0.000\\
\hline
mAP & \textbf{0.718} & 0.710 & 0.684 & 0.000\\
\hline
\end{tabular}
\end{table}
